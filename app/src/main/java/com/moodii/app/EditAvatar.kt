...
class EditAvatar : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem) = when (item.itemId) {
        ...
        val avatarViews = arrayOf (
                ...
                findViewById<AppCompatImageView>(R.id.hairTop),
                findViewById<AppCompatImageView>(R.id.hairBack),
                findViewById<AppCompatImageView>(R.id.eyes),
                findViewById<AppCompatImageView>(R.id.nose),
                findViewById<AppCompatImageView>(R.id.mouth),
                findViewById<AppCompatImageView>(R.id.eyebrows)
        )

        val buttonViews = arrayOf (
                findViewById<AppCompatImageButton>(R.id.buttonHead),
                findViewById<AppCompatImageButton>(R.id.buttonHairTop),
                findViewById<AppCompatImageButton>(R.id.buttonHairBack),
                findViewById<AppCompatImageButton>(R.id.buttonEyes),
                findViewById<AppCompatImageButton>(R.id.buttonNose),
                findViewById<AppCompatImageButton>(R.id.buttonMouth),
                findViewById<AppCompatImageButton>(R.id.buttonEyebrows)
                )
